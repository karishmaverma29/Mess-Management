...
//   src={image}
//   alt="Description"
//   style={{ display: 'block', margin: '0 auto' ,height: 200 , width:200}}
// />

// {/* Upload File Input */}
// <input type="file" style={{ marginTop: '20px', marginLeft:'80px'}} />
...
// {/* Submit Button */}
// <button style={{ marginTop: '20px' }} className="btn btn-success" onClick={handleSubmit}>Submit</button>
// </div>
//   )
// }
